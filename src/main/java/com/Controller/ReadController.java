...
public class ReadController {
	...
	@GetMapping("/chapter")
	public String ShowChapter(Model model, @RequestParam(defaultValue = "1", value = "pageNum") Integer pageNum,
	...
	@ResponseBody
	@GetMapping("/chapter2")
	public List<noveldetails> ShowChapter2(Model model,
	...
	@GetMapping("/content")
	public String ShowContent(Model model, @RequestParam(defaultValue = "1", value = "pageNum") Integer pageNum,
			@RequestParam(value = "nid") Integer nid, @RequestParam(value = "cid") Integer cid) {
